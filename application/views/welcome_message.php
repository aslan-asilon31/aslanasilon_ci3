...
<head>
    ...
    <meta name="description" content="Welcome to Aslan's Portfolio. Full-Stack Web Developer and Android App Developer" />
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/frontend/css/style.css')?>">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-iBBXm8fW90+nuLcSKlbmrPcLa0OT92xO1BIsZ+ywDWZCvqsWgccV3gFoRBv0z+8dLJgyAHIhR35VZc2oM/gI1w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <!-- Favicon -->
    <link id='favicon' rel="shortcut icon" href="<?= base_url('assets/frontend/images/favicon1.png')?>" type="image/x-png">
    <title>Portfolio | Aslan</title>
</head>
<body oncontextmenu="return false">

<!-- pre loader -->
<!-- <div class="loader-container">
  <img draggable="false" src="<?= base_url()?>assets/frontend/images/preloader.gif" alt="">
</div> -->
...
<section class="home" id="home">
    ...
    <div class="content">
    <h2>Hi There,<br/> I'm Aslan <span>Asilon</span></h2>
...
<div class="image">
    <img draggable="false" class="tilt" src="<?= base_url()?>assets/frontend/images/hero2.png" alt="">
</div>
</section>
<!-- hero section ends -->
...
<section class="about" id="about">
    ...
    <div class="image">
        <img draggable="false" class="tilt" src="<?= base_url()?>assets/frontend/images/profile2.jpg" alt="">
    </div>
    <div class="content">
        <h3>I'm Aslan</h3>
        <span class="tag">Full Stack Developer</span>
        
        <p>I am a Full-Stack developer based in Jakarta, Indonesia. 
        ...
        <div class="box-container">
            ...
            <div class="box">
              <p><span> email : </span> sulaslansetiawan1@gmail.com</p>
...
<section class="education" id="education">
  ...
  <h1 class="heading"><i class="fas fa-graduation-cap"></i> My <span>Experience</span></h1>
    ...
    <div class="box">
        <div class="image">
        <img draggable="false" src="<?= base_url()?>assets/frontend/images/educat/college.jpg" alt="">
        </div>
        <div class="content">
    ...
    <div class="box">
      <div class="image">
      <img draggable="false" src="<?= base_url()?>assets/frontend/images/educat/school.jpg" alt="">
      </div>
      <div class="content">
...
<section class="work" id="work">
  ...
  <div class="box-container">
    ...
    <!-- <div class="box tilt">
      <img draggable="false" src="<?= base_url()?>assets/frontend/images/projects/portfolio1.PNG" alt="" />
      <div class="content">
        <div class="tag">
...
<section class="contact" id="contact">
  ...
  <div class="container">
    <div class="content">
      <div class="image-box">
        <img draggable="false" src="<?= base_url()?>assets/frontend/images/contact1.png" alt="">
      </div>
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          ...
          <p> <i class="fas fa-envelope"></i>sulaslansetiawan1@gmail.com</p>
...
<!-- particle.js links -->
<script src="<?= base_url('assets/frontend/assets/js/particles.min.js')?>"></script>
